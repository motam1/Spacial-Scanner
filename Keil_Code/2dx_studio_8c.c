...
void PortF_Init(void){
  SYSCTL_RCGCGPIO_R |= SYSCTL_RCGCGPIO_R5;                 	// Activate the clock for Port L
	...
	GPIO_PORTF_DIR_R=0b00010001;															// Enable PL0 as output
	GPIO_PORTF_DEN_R=0b00010001;															// Enable PL0 as digital pin
	return;
}
...
int main(void) {
  uint8_t byteData, sensorState=0, myByteArray[10] = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF} , i=0;
	//uint8_t byteData2, sensorState2=0, myByteArray2[10] = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF} , i2=0;
  uint16_t wordData;
  uint16_t Distance;
  uint16_t SignalRate;
